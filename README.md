...
![Game Options](/assets/images-readme/options.png)
...
![Scores](/assets/images-readme/scores.png)
...
![Tries](/assets/images-readme/tries-remaining.png)

### Display Winner

- The displayWinner function is called within the triesRemaining function once all tries have been used.
- This function compares which score is greater, the users or the computers and declares an overall winner. The function also allows for a tie situation if the users score equals the computers score and thus declares a draw.

![Display-Winner](/assets/images-readme/display-winner.png)
